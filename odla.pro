...
macx {
    ...
    INCLUDEPATH += /opt/homebrew/Cellar/libusb/*/include/libusb-1.0
    DEPENDPATH += /opt/homebrew/Cellar/libusb/*/include/libusb-1.0
    PRE_TARGETDEPS += /usr/local/Cellar/libusb/*/lib/libusb-1.0.a
    LIBS += -framework IOKit
    LIBS += -framework CoreFoundation
    LIBS += -framework Foundation
    LIBS += /opt/homebrew/Cellar/libusb/*/lib/libusb-1.0.a
    QMAKE_LFLAGS += -F/Library/Frameworks/
    DISTFILES += appnap.m
    DEFINES += ICON_NAME='\\"'odla.png'\\"'
    DISTFILES += odla.png
    ICON = odla.png
    RC_ICONS = odla.png

...
AdditionalIcons=Raccourcis supplémentaires :
CreateDesktopIcon=Créer un raccourci sur le bureau %1
CreateQuickLaunchIcon=Créer un raccourci %1 dans la barre de lancement rapide
ProgramOnTheWeb=%1 sur le Web
UninstallProgram=Désinstaller %1
LaunchProgram=Lancer %1
AssocFileExtension=&Associer %1 à l'extension de fichier %2
AssocingFileExtension=Association de %1 à l'extension de fichier %2...
AutoStartProgramGroupDescription=Démarrage :
AutoStartProgram=Exécuter %1 au démarrage
AddonHostProgramNotFound=%1 n'a pas pu être trouvé dans le dossier que vous avez sélectionné.%n%nVoulez-vous continuer malgré tout ?
OldVersionFound=Une version précédente d'ODLA a été trouvée sur l'ordinateur, et il est nécessaire de la désinstaller avant de continuer. Si la version installée est la 1.5.5 ou antérieure, Musescore ODLA sera également supprimé.
OldVersionFoundMusescore=Pour utiliser Musescore 4 avec ODLA, vous devez d'abord installer Musescore 4. Si vous continuez sans le faire, vous devrez réinstaller ODLA pour garantir une intégration correcte.
InstallMusescore4=MuseScore 4 n'a pas été trouvé ou le chemin fourni est invalide
PathsTitle=Chemins d'installation
CustomSelectDir=Sélectionnez l'emplacement de destination pour %1
InstallationPaths=Choisissez vos chemins d'installation
OdlaStartup=Démarrer ODLA maintenant
MusescoreStartup=Démarrer Musescore ODLA maintenant
FileExists=Le fichier existe déjà.%n%nVoulez-vous que l'installation le remplace ?
AskForMS4=Avez-vous une version installée de MuseScore 4 ?
SelectFolder=Sélectionnez le répertoire d'installation de MuseScore 4
MustHaveMS4=Installez d'abord MuseScore 4

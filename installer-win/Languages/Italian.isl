...
CreateDesktopIcon=Crea un collegamento a %1 sul &desktop
CreateQuickLaunchIcon=Crea un collegamento a %1 nella &barra 'Avvio veloce'
...
AutoStartProgram=Esegui %1 all'avvio di windows
AddonHostProgramNotFound=Impossibile individuare %1 nella cartella selezionata.%n%nVuoi continuare ugualmente?
OldVersionFound=È stata trovata una versione precedente di ODLA sul computer, è necessario disinstallarla prima di procedere. Se la versione installata è la 1.5.5 o precedente, verrà rimosso anche Musescore ODLA.
OldVersionFoundMusescore=È stata trovata una versione precedente di Musescore ODLA sul computer, è necessario disinstallarla prima di provedere. (Questo disinstallerà anche MuseScore)
InstallMusescore4=Per usare Musescore 4 con ODLA, devi installare prima Musescore 4. Se procedi senza farlo, dovrai reinstallare ODLA per garantirne l’integrazione.
PathsTitle=Percorsi d'installazione
CustomSelectDir=Selezione cartella di installazione per %1
InstallationPaths=Scegli i percorsi d'installazione
OdlaStartup=Avvia ODLA adesso
MusescoreStartup=Avvia Musescore ODLA adesso
AskForMS4=Hai MuseScore 4 installato?
SelectFolder=Seleziona la directory di installazione di MuseScore 4